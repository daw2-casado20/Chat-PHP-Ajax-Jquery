...
if(isset($_POST["register"]))
{
	...
	if($statment->execute($check_data))	
	{
		...
		else
		{
			...
			if($message == '')
			{
				...
				$passwordCifred = password_hash($password, PASSWORD_DEFAULT);
				$loginuserst = new Login($connect);
        		$loginuserst->setusername($username)->setpassword($passwordCifred)->Save();
				/*if($loginuserst->execute($data))
				{
